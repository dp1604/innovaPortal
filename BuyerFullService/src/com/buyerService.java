...
public class buyerService {
	...
	//Insert Details bid added please check
	@POST
	@Path("/") 
	@Consumes(MediaType.APPLICATION_FORM_URLENCODED) 
	@Produces(MediaType.TEXT_PLAIN) 
	public String insertItem(@FormParam("bid") String bid1,@FormParam("name") String name1, 
	...
	{ 
		 String output = buyerObj.insertItem(bid1,name1, descri1,address1,email1,pwd1,tp1,gender1); 
		 return output; 
	}
	...
	{ 
		...
		@Produces(MediaType.TEXT_HTML)
		public String  ViewBuyerDetails(@FormParam("bid") String buyerId) 
		{
		...
		@Produces(MediaType.TEXT_HTML)
		public String  purchasePro(@FormParam("bid") String buyerId) 
		{
